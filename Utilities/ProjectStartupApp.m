classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Fourier-Analysis-jp";
    ...
    methods (Access = private)
        ...
        function FacultyButtonPushed(app, event)
            ...
            uri.Query = [
                ...
                QueryParameter('r2017080ed20546d1a2db18fe36421929', app.ProjectName+" jp")
                ];
        ...
        function StudentButtonPushed(app, event)
            ...
            uri.Query = [
                ...
                QueryParameter('r362e367caa234debbf4f65a58a0338e6', app.ProjectName+" jp")
                ];
            web(strrep(uri.EncodedURI,"+","%20"))
            StartUpAppUIFigureCloseRequest(app,event)
        end
